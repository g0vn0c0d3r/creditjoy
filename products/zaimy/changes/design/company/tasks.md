...
Подписи и формат значений — как в первом экране ([пункт 2](#02-первый-экран--сумма-срок-ставка-и-пск)): небольшая подпись сверху, крупное значение снизу, единицы измерения без повторов. Значения показывать полностью, без многоточий.
