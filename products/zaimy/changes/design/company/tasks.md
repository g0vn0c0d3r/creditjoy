...
- Маркеры — под иконкой заголовка, продолжение пункта — под его текстом.
- Отступы и интервалы одинаковые в обеих колонках.
...
- Подписи и формат значений — как в первом экране ([пункт 2](#02-первый-экран--сумма-срок-ставка-и-пск)): небольшая подпись сверху, крупное значение снизу.
