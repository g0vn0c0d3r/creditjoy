...
**Есть:** «Проверено» прижато к верхней рамке таблицы. В «Условиях специального предложения» пункты идут с новой строки без маркеров, со сдвигом вправо.

**Нужно:**

- «Проверено» выровнять по центру строки с заголовком «Условия займов». Между этой строкой и таблицей — 16 px.
...
**Есть:** «Проверено» касается таблицы. Условия акции выглядят как длинные абзацы без маркеров с лишним отступом слева; иконка заголовка стоит между двумя строками.

**Нужно:**

- «Проверено» — отдельной строкой под заголовком: 8 px от заголовка, 16 px до таблицы.
