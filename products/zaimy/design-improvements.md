...
Текущий первый экран на мобиле:

![Текущий первый экран на мобиле](assets/task-01-mobile-hero-current.png)

Текущий переход к каталогу на мобиле:

![Текущий переход к каталогу на мобиле](assets/task-01-mobile-catalog-current.png)
